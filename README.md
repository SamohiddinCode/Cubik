...
Текущее состояние исходников: задачи сохраняются в localStorage браузера и остаются после обновления страницы. Реализованы списки, фильтры, подзадачи, массовые действия, отмена/повтор, «Сводка», календарь день/неделя/месяц с повторяющимися событиями, матрица Эйзенхауэра и Focus Lite с Pomodoro-циклами и учётом фактического времени по задачам. Backend, настоящая авторизация и AI пока не подключены. Данные конкретного браузера в архив исходников не входят.

Для продолжения разработки сначала прочитайте `docs/AI_HANDOFF.md`, затем документ нужного модуля: `docs/PLANNER_TASKS.md`, `docs/PLANNER_CALENDAR.md`, `docs/PLANNER_EISENHOWER.md` или `docs/PLANNER_FOCUS.md`. Архив содержит текущие локальные изменения, включая ещё не отправленные в GitHub.
...
- [Матрица Эйзенхауэра](docs/PLANNER_EISENHOWER.md)
- [Фокус и Pomodoro](docs/PLANNER_FOCUS.md)
