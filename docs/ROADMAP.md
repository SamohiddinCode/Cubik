...
- `[~]` полный scope раздела «Задачи»: системные секции, favorite, P1–P4, ручной порядок и расширенный quick add готовы; массовые действия, undo и полный CRUD вложенных объектов ещё в работе;
